...
@WebServlet("/app/quotation-item/*")
public class QuotationItemImageServlet extends HttpServlet {
    ...
    public static void copyFile(String filename, String mimeType, HttpServletResponse response) throws IOException {
        ...
        Map map = AWSClient.retreiveImage(filename, AppConstants.QUOTATION_ITEM_BUCKET_NAME);
